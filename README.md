...
| `vectojs-knowledge-graph`   | 2D node-link knowledge graphs: batch-painted layers, d3-force layout, pan/zoom, hit-testing, the dirty/onDemand contract, Canvas2D→WebGL→WebGPU ladder |
